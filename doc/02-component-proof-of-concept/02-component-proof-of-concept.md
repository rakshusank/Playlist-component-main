...
I wanted to make a playlist component because its both fun and practial and uses key software concepts like adding, removing, etc. My proof of concept will provide a baseline structure that can store songs, and display them. 
